...
const C = class C {
	...
	setFillMode(t) {
		t === "random" && (this.particles.randomFill = !0), t === "fill" && (this.particles.randomFill = !0, l(this, p).forEach((i) => i.fillStyle = this.particles.fillStyle)), t === "noFill" && (this.particles.noFill = !0, l(this, p).forEach((i) => i.fillStyle = "none"));
	}
	setSpeed(t) {
